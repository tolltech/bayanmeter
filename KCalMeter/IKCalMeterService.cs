...
{
    Task WritePortion(string name, decimal portion, long chatId, long userId, DateTime messageDate);
    ...
    Task<FoodDbo[]> SelectFood(int count, long chatId, long userId, string? sub);
}